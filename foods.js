...
const FOODS = [
  ...
  f('arabic-bread', 'خبز عربي', 'Arabic bread (khubz)', 'grain', 275, 9, 55, 1.2,
    { fiber: 2.5, sugar: 1.5, satfat: 0.2, sodium: 500, potassium: 120, calcium: 90, iron: 3.2, magnesium: 25, zinc: 0.8 }, 60, { ar: 'رغيف', en: 'loaf', g: 60 }),
  f('white-bread', 'خبز أبيض', 'White bread', 'grain', 265, 9, 49, 3.2,
    { fiber: 2.7, sugar: 5.0, satfat: 0.7, sodium: 491, potassium: 115, calcium: 144, iron: 3.6, magnesium: 23, zinc: 0.7 }, 30, { ar: 'شريحة', en: 'slice', g: 30 }),
  f('brown-bread', 'خبز أسمر', 'Whole-wheat bread', 'grain', 247, 13, 41, 3.4,
    { fiber: 7.0, sugar: 6.0, satfat: 0.7, sodium: 450, potassium: 250, calcium: 107, iron: 2.5, magnesium: 75, zinc: 1.8 }, 32, { ar: 'شريحة', en: 'slice', g: 32 }),
  f('tamees', 'تميس / خبز تنور', 'Tamees / tandoor bread', 'grain', 290, 9, 57, 3,
    { fiber: 2.5, sugar: 2.0, satfat: 0.6, sodium: 480, potassium: 120, calcium: 60, iron: 3.0, magnesium: 28, zinc: 0.8 }, 120, { ar: 'رغيف', en: 'loaf', g: 120 }),
  ...
  f('potato', 'بطاطس مسلوقة', 'Potato, boiled', 'grain', 87, 1.9, 20, 0.1,
    { fiber: 1.8, sugar: 0.9, sodium: 4, potassium: 379, calcium: 8, iron: 0.3, magnesium: 20, zinc: 0.3, vitC: 13 }, 150, { ar: 'حبة', en: 'piece', g: 150 }),
  f('sweet-potato', 'بطاطا حلوة', 'Sweet potato', 'grain', 90, 2, 21, 0.2,
    { fiber: 3.3, sugar: 6.5, sodium: 36, potassium: 475, calcium: 38, iron: 0.7, magnesium: 27, zinc: 0.3, vitA: 709, vitC: 12.8 }, 150, { ar: 'حبة', en: 'piece', g: 130 }),
  ...
  f('tomato', 'طماطم', 'Tomato', 'veg', 18, 0.9, 3.9, 0.2,
    { fiber: 1.2, sugar: 2.6, sodium: 5, potassium: 237, calcium: 10, iron: 0.3, magnesium: 11, zinc: 0.2, vitA: 42, vitC: 14 }, 120, { ar: 'حبة', en: 'piece', g: 120 }),
  f('cucumber', 'خيار', 'Cucumber', 'veg', 15, 0.7, 3.6, 0.1,
    { fiber: 0.5, sugar: 1.7, sodium: 2, potassium: 147, calcium: 16, iron: 0.3, magnesium: 13, zinc: 0.2, vitA: 5, vitC: 2.8 }, 100, { ar: 'حبة', en: 'piece', g: 180 }),
  f('onion', 'بصل', 'Onion', 'veg', 40, 1.1, 9.3, 0.1,
    { fiber: 1.7, sugar: 4.2, sodium: 4, potassium: 146, calcium: 23, iron: 0.2, magnesium: 10, zinc: 0.2, vitC: 7.4 }, 80, { ar: 'حبة', en: 'piece', g: 110 }),
  ...
  f('carrot', 'جزر', 'Carrot', 'veg', 41, 0.9, 9.6, 0.2,
    { fiber: 2.8, sugar: 4.7, sodium: 69, potassium: 320, calcium: 33, iron: 0.3, magnesium: 12, zinc: 0.2, vitA: 835, vitC: 5.9 }, 80, { ar: 'حبة', en: 'piece', g: 60 }),
  f('bell-pepper', 'فلفل رومي', 'Bell pepper', 'veg', 31, 1, 6, 0.3,
    { fiber: 2.1, sugar: 4.2, sodium: 4, potassium: 211, calcium: 7, iron: 0.4, magnesium: 12, zinc: 0.3, vitA: 157, vitC: 128 }, 120, { ar: 'حبة', en: 'piece', g: 120 }),
  f('eggplant', 'باذنجان', 'Eggplant', 'veg', 25, 1, 5.9, 0.2,
    { fiber: 3.0, sugar: 3.5, sodium: 2, potassium: 229, calcium: 9, iron: 0.2, magnesium: 14, zinc: 0.2, vitC: 2.2 }, 100, { ar: 'حبة', en: 'piece', g: 250 }),
  f('zucchini', 'كوسا', 'Zucchini', 'veg', 17, 1.2, 3.1, 0.3,
    { fiber: 1.0, sugar: 2.5, sodium: 8, potassium: 261, calcium: 16, iron: 0.4, magnesium: 18, zinc: 0.3, vitA: 10, vitC: 17.9 }, 120, { ar: 'حبة', en: 'piece', g: 200 }),
  ...
  f('dates', 'تمر', 'Dates', 'fruit', 282, 2.5, 75, 0.4,
    { fiber: 8.0, sugar: 63, sodium: 2, potassium: 656, calcium: 39, iron: 1.0, magnesium: 43, zinc: 0.4 }, 24, { ar: 'تمرة', en: 'date', g: 24 }),
  f('banana', 'موز', 'Banana', 'fruit', 89, 1.1, 23, 0.3,
    { fiber: 2.6, sugar: 12, sodium: 1, potassium: 358, calcium: 5, iron: 0.3, magnesium: 27, zinc: 0.2, vitC: 8.7 }, 120, { ar: 'حبة', en: 'piece', g: 120 }),
  f('apple', 'تفاح', 'Apple', 'fruit', 52, 0.3, 14, 0.2,
    { fiber: 2.4, sugar: 10, sodium: 1, potassium: 107, calcium: 6, iron: 0.1, magnesium: 5, zinc: 0.04, vitC: 4.6 }, 180, { ar: 'حبة', en: 'piece', g: 180 }),
  f('orange', 'برتقال', 'Orange', 'fruit', 47, 0.9, 12, 0.1,
    { fiber: 2.4, sugar: 9.4, potassium: 181, calcium: 40, iron: 0.1, magnesium: 10, zinc: 0.07, vitA: 11, vitC: 53 }, 130, { ar: 'حبة', en: 'piece', g: 130 }),
  ...
  f('mango', 'مانجو', 'Mango', 'fruit', 60, 0.8, 15, 0.4,
    { fiber: 1.6, sugar: 14, sodium: 1, potassium: 168, calcium: 11, iron: 0.2, magnesium: 10, zinc: 0.1, vitA: 54, vitC: 36 }, 150, { ar: 'حبة', en: 'piece', g: 200 }),
  ...
  f('fig', 'تين', 'Figs', 'fruit', 74, 0.8, 19, 0.3,
    { fiber: 2.9, sugar: 16, sodium: 1, potassium: 232, calcium: 35, iron: 0.4, magnesium: 17, zinc: 0.2, vitC: 2 }, 50, { ar: 'حبة', en: 'piece', g: 50 }),
